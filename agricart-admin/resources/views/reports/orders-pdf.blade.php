...
<body>
    ...
    <div class="summary">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-item">
                <div class="summary-value revenue">₱{{ number_format($summary['total_revenue'], 2) }}</div>
    ...
    <div class="order-details">
        ...
        <div class="order-header">
            <strong>Order #{{ $order->id }}</strong> - {{ $order->customer->name ?? 'N/A' }} - ₱{{ number_format($order->total_amount, 2) }}
            <br>
