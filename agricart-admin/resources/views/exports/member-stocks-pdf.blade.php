    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">₱{{ number_format($stock['unit_price'], 2) }}</td>
                <td class="text-right">₱{{ number_format($stock['total_revenue'], 2) }}</td>
                <td class="text-right">₱{{ number_format($stock['total_cogs'], 2) }}</td>
                <td class="text-right">₱{{ number_format($stock['total_gross_profit'], 2) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
