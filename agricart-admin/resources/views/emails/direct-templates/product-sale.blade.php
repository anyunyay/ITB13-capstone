...
<head>
    ...
    <title>Product Sale Notification Email Template</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1>💰 Product Sale Notification</h1>
        ...
        <div class="footer">
            <p>This is an automated sale notification from AgriCart Admin System.</p>
            <p>Thank you for being part of our agricultural community!</p>
