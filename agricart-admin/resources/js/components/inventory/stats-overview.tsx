    ...
    return (
        <div className="grid grid-cols-2 gap-2 sm:gap-3 md:grid-cols-3 lg:grid-cols-5">
            ...
            <div className="col-span-2 md:col-span-1 bg-card border border-border rounded-lg p-3 sm:p-5 flex items-center gap-2 sm:gap-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:border-primary">
                ...
                <div className="flex-1 min-w-0">
                    <div className="text-lg sm:text-xl font-bold text-foreground leading-none">{stockStats.outOfStockItems}</div>
                    <div className="text-xs sm:text-sm text-muted-foreground mt-1 truncate">{t('admin.out_of_stock')}</div>
                </div>
            </div>
        </div>
    );
