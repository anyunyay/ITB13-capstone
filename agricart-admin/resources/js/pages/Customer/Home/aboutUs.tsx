...
export default function AboutUs({ }: PageProps) {
    ...
    return (
        <AppHeaderLayout>
                        ...
                        <div className="w-full h-full relative">
                            ...
                            <div className="absolute inset-0 flex items-end justify-start text-white z-30 pl-30 pb-30">
                                ...
                                >
                                    ...
                                    <motion.p 
                                        className="text-2xl font-light mb-8 max-w-4xl mx-auto leading-relaxed"
            ...
            {/* Who We Are Section */}
            <section id="who-we-are" className="h-screen flex items-center justify-center bg-white">
            ...
            <section className={`py-20 bg-gradient-to-br from-primary to-primary/80 text-white ${styles.heroGradient}`}>
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <motion.p 
                            className="text-lg sm:text-xl mb-6 sm:mb-8 leading-relaxed px-4"
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.6, delay: 0.2, ease: "easeOut" }}
                            viewport={{ once: true }}
