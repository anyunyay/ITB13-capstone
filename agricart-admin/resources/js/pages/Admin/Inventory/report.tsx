          ...
          <div className="bg-gradient-to-br from-card to-[color-mix(in_srgb,var(--card)_95%,var(--primary)_5%)] border border-border rounded-xl p-6 shadow-lg">
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex gap-2 w-full md:w-auto">
                <Button onClick={() => exportReport('csv', localFilters, route)} variant="outline" className="flex items-center justify-center gap-2 flex-1 md:flex-none">
                  <Download className="h-4 w-4" />
                  {t('admin.export_csv')}
                </Button>
                <Button onClick={() => exportReport('pdf', localFilters, route)} variant="outline" className="flex items-center justify-center gap-2 flex-1 md:flex-none">
